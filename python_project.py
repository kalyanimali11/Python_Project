...
class MainWindow:
    ...
    def __init__(self, root):
        ...
        self.label_text = Label(
            root, text="Welcome to typing speed calculator", wraplength=200)
        self.label_text.grid(row=0, column=0, columnspan=3, sticky="nsew")
        self.label_text.configure(bg="#cfe2f3")  
        self.label_text.configure(fg="black")
        bold_font = tkfont.nametofont("TkDefaultFont")
        bold_font.configure(weight="bold")
        self.label_text.configure(font=bold_font)
        ...
        self.btn_newtext.configure(bg="#3d85c6")  
        ...
        self.label_speed.configure(bg="lightgray")  
        ...
        self.label_accuracy.configure(bg="lightgray") 
